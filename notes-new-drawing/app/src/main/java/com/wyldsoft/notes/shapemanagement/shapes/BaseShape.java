...
public class BaseShape {
    ...
    public BaseShape setShapeType(int shapeType) {
        this.shapeType = shapeType;
        return this;
    }

    public BaseShape setTexture(int texture) {
        this.texture = texture;
        return this;
    }

    public BaseShape setStrokeColor(int strokeColor) {
        this.strokeColor = strokeColor;
        return this;
    }

    public BaseShape setStrokeWidth(float strokeWidth) {
        this.strokeWidth = strokeWidth;
        return this;
    }

    public BaseShape setTouchPointList(TouchPointList touchPointList) {
        this.touchPointList = touchPointList;
        return this;
    }
